...
class TestRecognizesContributionToRelationship:
    ...
    def test_create_recognizes_contribution_to_project_relationship(self, mock_get_db):
        ...
        mock_session.execute_write = Mock(return_value=Relationship(**self.recognition_project_relationship))
